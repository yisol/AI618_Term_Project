...
class ODDataset(data.Dataset):
    def __init__(self,
        ...
        json_file_name = './data/train_solution_bounding_boxes (1).csv'
    ...
    def draw_bbox(image, point1, point2):
        ...
        draw.rectangle((point1, point2), color=(0,255,0), thickness=2)
        return image
    ...
    def __getitem__(self, index):
        ...
        result["before"] = Image.open(self.img_dir[index]).resize((512, 512)).convert('RGB')
        ...
        # draw bbox
        result["after"] = draw_bbox(result["before"], start_point, end_point)
